...
def register():
    ...
    try:
        ...
        doctor_data = {
            ...
            "license_number": data.get("license_number") or data.get("licenseNumber"),
            "council": data.get("council"),
            "degree": data.get("degree"),
            "specialty": data.get("specialty"),
            "experience": data.get("experience"),
            "clinic_name": data.get("clinic_name") or data.get("clinicName"),
            "clinic_address": data.get("clinic_address") or data.get("clinicAddress"),
            "profile_photo": data.get("profile_photo") or data.get("photoPath", ""),
